...
type ComplexMessage struct {
	...
	SingleMessage    *DummyMessage   `protobuf:"bytes,1,opt,name=single_message,json=singleMessage,proto3" json:"single_message,omitempty"`
	MultipleMessages []*DummyMessage `protobuf:"bytes,2,rep,name=multiple_messages,json=multipleMessages,proto3" json:"multiple_messages,omitempty"`
}
...
func (x *ComplexMessage) GetSingleMessage() *DummyMessage {
	if x != nil {
...
func (x *ComplexMessage) GetMultipleMessages() []*DummyMessage {
	if x != nil {
		return x.MultipleMessages
	}
	return nil
}
...
var file_complex_complex_proto_rawDesc = []byte{
	...
	0x61, 0x67, 0x65, 0x12, 0x3c, 0x0a, 0x0e, 0x73, 0x69, 0x6e, 0x67, 0x6c, 0x65, 0x5f, 0x6d, 0x65,
	0x73, 0x73, 0x61, 0x67, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x15, 0x2e, 0x63, 0x6f,
	...
	0x65, 0x12, 0x42, 0x0a, 0x11, 0x6d, 0x75, 0x6c, 0x74, 0x69, 0x70, 0x6c, 0x65, 0x5f, 0x6d, 0x65,
	...
	0x61, 0x67, 0x65, 0x52, 0x10, 0x6d, 0x75, 0x6c, 0x74, 0x69, 0x70, 0x6c, 0x65, 0x4d, 0x65, 0x73,
	0x73, 0x61, 0x67, 0x65, 0x73, 0x22, 0x32, 0x0a, 0x0c, 0x44, 0x75, 0x6d, 0x6d, 0x79, 0x4d, 0x65,
	0x73, 0x73, 0x61, 0x67, 0x65, 0x12, 0x0e, 0x0a, 0x02, 0x49, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28,
	0x05, 0x52, 0x02, 0x49, 0x64, 0x12, 0x12, 0x0a, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x18, 0x02, 0x20,
...
var file_complex_complex_proto_depIdxs = []int32{
	1, // 0: complex.ComplexMessage.single_message:type_name -> complex.DummyMessage
	1, // 1: complex.ComplexMessage.multiple_messages:type_name -> complex.DummyMessage
